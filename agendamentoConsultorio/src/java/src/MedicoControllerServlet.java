...
public class MedicoControllerServlet extends HttpServlet {
    ...
    dt_Nascimento DATE,*/
		...
		int codMedico = Integer.parseInt(request.getParameter("medicoId")); //ID � o campo identificador sequencial
	...
	private void addMedico(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		// le informa��es de medico do form recebido
		...
		// cria novo objeto medico - chama construtor com CRM pois este � digitado
